...
class TouraineloirevalleyActivites extends Crawler
{

    protected $url = 'http://www.touraineloirevalley.com/dormir-manger-sortir/activites/(offset)/';
    ...
    function getPages($xhtml, $itemOffset)
    {
        ...
        foreach ($nodes as $node) {
            ...
            $name = str_replace('/dormir-manger-sortir/activites/', '', $n2s[0]->a['href']);
